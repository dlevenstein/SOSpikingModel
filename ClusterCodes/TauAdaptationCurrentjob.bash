...
matlab -nodisplay -nodesktop -singleCompThread -r "cd('/gpfs/data/buzsakilab/DL/SOSpikingModel/ClusterCodes');addPaths;CondAdLIF_iSTDP_TauAdapt('/gpfs/data/buzsakilab/DL/SOSpikingModel','Uniform');exit;"
