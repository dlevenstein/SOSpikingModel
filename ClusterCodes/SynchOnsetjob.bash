...
matlab -nodisplay -nodesktop -singleCompThread -r "cd('/gpfs/data/buzsakilab/DL/SOSpikingModel/ClusterCodes');addPaths;CondAdLIF_iSTDP_PSpikeOnset('/gpfs/data/buzsakilab/DL/SOSpikingModel',75);exit;"
