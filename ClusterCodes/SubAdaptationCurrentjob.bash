...
matlab -nodisplay -nodesktop -singleCompThread -r "cd('/gpfs/data/buzsakilab/DL/SOSpikingModel/ClusterCodes');addPaths;CondAdLIF_iSTDP_SubAdaptation_Current('/gpfs/data/buzsakilab/DL/SOSpikingModel','Uniform');exit;"
