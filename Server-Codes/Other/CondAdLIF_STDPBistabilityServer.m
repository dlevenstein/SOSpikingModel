function CondAdLIF_STDPBistabilityServer(llrr)
...
%Network Properties
PopParams.Wee   = Weights(llrr);        %E->E weight (nS)
PopParams.Wii   = Weights(llrr);        %I->I weight
PopParams.Wie   = Weights(llrr);        %E->I weight
