...
dropboxpath = '/home/jmg1030/SOSpikingModel'; 
...
for llrr = 1:length(LearningRates)
...
SimValues = AdLIFfunction_STDP(PopParams,TimeParams,'cellout',true,'showprogress',true,...
    ...
    'recordInterval',10000,'recordIntervalPath',['/home/jmg1030/SOSpikingModel/Data/Balance/learningRate' LearningRateNames(llrr)]);
toc 

if SAVESIM==true
    save(fullfile(simfolder,['longinhSTDP_fastrate' LearningRateNames(llrr)]),'-v7.3')
end
