...
PopParamsAnalysis.W = gather(SimValues.WeightMat);
...
datafolder = '/scratch/jmg1030/FIcurve/data/bistabilityTest/DOWN/iSTDPLognormal/';
dataname = ['iSTDP_Lognormal_m_1_s_10_sim_' char(num2str(simnum))];
