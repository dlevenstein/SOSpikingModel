...
W(IcellidX,IcellidX) = w.*W(IcellidX,IcellidX);
W(EcellidX,IcellidX) = w.*W(EcellidX,IcellidX);
...
filename = 'Uniform_w_1_TrainingAnalysis';

disp('U(1),Plastic I->E, Indegree 250 E->E, 250 I->I, 250 E->I, 250 I->E')

PopParams

elseif index == 14 %L(1,10) Experimental Rates
...
filename = 'Lognormal_m_1_s_10_EE_ExperimentalRates';
