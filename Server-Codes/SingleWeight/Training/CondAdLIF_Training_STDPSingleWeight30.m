...
%Network Properties
PopParams.Wee   = 30;        %E->E weight (nS)
PopParams.Wii   = 30;        %I->I weight
PopParams.Wie   = 30;        %E->I weight
PopParams.Wei   = 30;        %I->E weight
...
save('/home/jmg1030/Documents/spikingModel/data/UniformWeight_w_30','-v7.3')