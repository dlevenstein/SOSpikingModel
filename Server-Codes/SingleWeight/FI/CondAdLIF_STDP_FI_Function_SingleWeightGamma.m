function [] = CondAdLIF_STDP_FI_Function_SingleWeightGamma(index)
...
%%
names = ["largePopWeight01.mat","largePopWeight1.mat","largePopWeight10.mat"];
weightNames = ["01","1","10"];
...
dataname = ['singleWeightGamma_' char(weightNames(LL)) '_sim_' char(num2str(simnum))];

disp([datafolder dataname]);

SimulateFICurveServer(PopParamsAnalysis,[0 400],21,datafolder,dataname,'up',false,'SaveALL',true);
