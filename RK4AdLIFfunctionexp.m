...
v1 = - g_L.*((v(:,n))-E_L)./C - g_e1.*((v(:,n))-E_e)./C - g_i1.*((v(:,n))-E_i)./C - (a(:,n))./C + 10000./C;
...
v2 = - g_L.*((v(:,n) + dt./2.*v1)-E_L)./C - g_e2.*((v(:,n) + dt./2.*v1)-E_e)./C - g_i2.*((v(:,n) + dt./2.*v1)-E_i)./C - (a(:,n) + dt./2.*a1)./C + 10000./C;
...
v3 = - g_L.*((v(:,n) + dt./2.*v2)-E_L)./C - g_e2.*((v(:,n) + dt./2.*v2)-E_e)./C - g_i2.*((v(:,n) + dt./2.*v2)-E_i)./C - (a(:,n) + dt./2.*a2)./C + 10000./C;
...
v4 = - g_L.*((v(:,n) + dt.*v3)-E_L)./C - g_e4.*((v(:,n) + dt.*v3)-E_e)./C - g_i4.*((v(:,n) + dt.*v3)-E_i)./C - (a(:,n) + dt.*a3)./C + 10000./C;
