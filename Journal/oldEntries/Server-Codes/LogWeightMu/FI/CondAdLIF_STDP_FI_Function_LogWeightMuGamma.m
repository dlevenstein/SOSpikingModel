function [] = CondAdLIF_STDP_FI_Function_LogWeightMuGamma(index)
...
%%
names = ["logWeight_m_01.mat","logWeight_m_1.mat","logWeight_m_10.mat"];
weightNames = ["01","1","10"];
...
datafolder = '/scratch/jmg1030/FIcurve/data/bistabilityTest/DOWN/LogWeightMu/Gamma/';
dataname = ['logMuWeightGamma_' char(weightNames(LL)) '_sim_' char(num2str(simnum))];
