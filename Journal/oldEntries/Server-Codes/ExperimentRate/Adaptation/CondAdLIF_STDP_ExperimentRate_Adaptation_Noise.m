function CondAdLIF_STDP_ExperimentRate_Adaptation_Noise(index)
...
save(['/scratch/jmg1030/FIcurve/data/bistabilityTest/Adaptation/ExperimentRate/Noise_50/AdaptationVCurrent_ii_' num2str(ii) '_bb_' num2str(bb) '.mat'],'SimValuesSave','-v7.3') 
