function CondAdLIF_Training_STDPLogWeightSigmaM1_LowInput(ss)
...
%Input
PopParams.I_e  = 210;       %External input
...
if SAVESIM==true
    %save(['/scratch/jmg1030/FIcurve/data/LowInputlogWeight_m_1_s_' char(names(ss))],'-v7.3')
    save(['/home/jmg1030/Documents/spikingModel/data/LowInputlogWeight_m_1_s_' char(names(ss))],'-v7.3')
end
