...
W(EcellidX,IcellidX) = lognrnd(mu,sigma,[EPopNum,IPopNum]).*W(EcellidX,IcellidX);
...
%%
SimValues = AdLIFfunction_STDP_GPU(PopParams,TimeParams,'cellout',true,'showprogress',true,'showfig',true,...
