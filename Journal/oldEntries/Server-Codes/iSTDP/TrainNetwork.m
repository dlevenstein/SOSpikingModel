function [SimValuesTest,PopParams_in] = TrainNetwork(SimValues,PopParams_in)
...
%% Learning
PopParams_in.LearningRate = 1e-2;
PopParams_in.TargetRateI = 2; %Target I rate 8Hz
PopParams_in.TargetRateE = nan; %Target E rate 2Hz
PopParams_in.tauSTDP = 20;

%% Noise
PopParams_in.I_e  = 250;       %External input
PopParams_in.sigma = 50;        %noise magnitude: variance
