function CondAdLIF_iSTDP_Training_Long(index)
...
elseif index == 2
    ...
    filename = 'Lognormal_m_1_s_10_EE_LognormalRates_Noise_10ms_50pA';

    disp('L(1,10),Plastic I->E (Lognormal Targets), Indegree 250 E->E, 250 I->I, 500 E->I, 250 I->E, Noise 10 ms, 50 pA')
