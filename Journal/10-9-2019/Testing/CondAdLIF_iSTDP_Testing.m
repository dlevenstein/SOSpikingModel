function CondAdLIF_iSTDP_Testing(modnum)
...
load(['/scratch/jmg1030/FIcurve/data/trainedWeights/LogWeightSigmaM1/Lognormal_m_1_s_' char(sVals(modnum)) '.mat']);
...
save(['/scratch/jmg1030/FIcurve/data/trainedWeights/LogWeightSigmaM1/Testing_Lognormal_m_1_s_' char(sVals(modnum)) '.mat'],'SimValues','-v7.3') 
