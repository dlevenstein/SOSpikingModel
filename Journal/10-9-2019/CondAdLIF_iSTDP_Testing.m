...
load(['/scratch/jmg1030/FIcurve/data/trainedWeights/Lognormal_m_1_s_' char(sVals(modnum)) '.mat']);
...
save(['/scratch/jmg1030/FIcurve/data/trainedWeights/Testing_Lognormal_m_1_s_' char(sVals(modnum)) '.mat'],'SimValues','-v7.3') 
