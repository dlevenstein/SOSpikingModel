...
II = modnum;
    ...
    save(['/scratch/jmg1030/FIcurve/data/testingFolder/10-14-2019/Bvals/AdaptationVCurrentSpikes_ii_' num2str(ii) '_bb_' num2str(bb) '.mat'],'spikes','-v7.3') 
