...
for II = 1:8
    ...
    save(['/scratch/jmg1030/FIcurve/data/testingFolder/8-24-2019/AdaptationVCurrentSpikes_ii_' num2str(ii) '_bb_' num2str(bb) '.mat'],'-struct','SimValuesArray','-v7.3') 
end
