...
static void emxInitStruct_cell_wrap_1(cell_wrap_1 *pStruct, boolean_T doPush)
{
  emxInit_real_T1(&pStruct->f1, 1, doPush);
}
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      ...
      if (emxArray->canFreeData) {
        emlrtFreeMex2018a(emlrtRootTLSGlobal, (void *)emxArray->data);
      }
    }
...
void emxEnsureCapacity_boolean_T1(emxArray_boolean_T *emxArray, int32_T oldNumel)
{
  int32_T newNumel;
  int32_T i;
  void *newData;
...
void emxEnsureCapacity_int32_T1(emxArray_int32_T *emxArray, int32_T oldNumel)
{
  int32_T newNumel;
  int32_T i;
  void *newData;
...
void emxEnsureCapacity_real32_T1(emxArray_real32_T *emxArray, int32_T oldNumel)
{
  int32_T newNumel;
  int32_T i;
  void *newData;
...
void emxEnsureCapacity_real_T1(emxArray_real_T *emxArray, int32_T oldNumel)
{
  int32_T newNumel;
  int32_T i;
  void *newData;
...
void emxEnsureCapacity_real_T2(emxArray_real_T *emxArray, int32_T oldNumel)
{
  int32_T newNumel;
  int32_T i;
  void *newData;
...
void emxFreeStruct_struct2_T(struct2_T *pStruct)
{
  ...
  emxFree_real_T(&pStruct->g_w);
  emxFree_real_T(&pStruct->g_e);
  emxFree_real_T(&pStruct->g_i);
  emxFree_real_T(&pStruct->s);
  emxFree_real_T(&pStruct->w);
  emxFree_real_T(&pStruct->a_w);
  emxFree_real_T(&pStruct->Input);
  emxFree_real_T(&pStruct->t_weight);
  emxFree_real_T(&pStruct->WeightMat);
  emxFree_real32_T(&pStruct->spikes);
  emxFree_real_T(&pStruct->EcellIDX);
  emxFree_real_T(&pStruct->IcellIDX);
}
...
void emxFree_boolean_T(emxArray_boolean_T **pEmxArray)
{
  if (*pEmxArray != (emxArray_boolean_T *)NULL) {
    ...
    {
      emlrtFreeMex2018a(emlrtRootTLSGlobal, (void *)(*pEmxArray)->data);
    }

    emlrtFreeMex2018a(emlrtRootTLSGlobal, (void *)(*pEmxArray)->size);
    emlrtFreeMex2018a(emlrtRootTLSGlobal, (void *)*pEmxArray);
...
void emxInitMatrix_cell_wrap_1(cell_wrap_1 pMatrix[2], boolean_T doPush)
{
  int32_T i;
  for (i = 0; i < 2; i++) {
...
{
  emxInit_real_T(&pStruct->t, 2, doPush);
  emxInit_real_T(&pStruct->V, 2, doPush);
  emxInit_real_T(&pStruct->g_w, 2, doPush);
  emxInit_real_T(&pStruct->g_e, 2, doPush);
  emxInit_real_T(&pStruct->g_i, 2, doPush);
  emxInit_real_T(&pStruct->s, 2, doPush);
  emxInit_real_T(&pStruct->w, 2, doPush);
  emxInit_real_T(&pStruct->a_w, 2, doPush);
  emxInit_real_T(&pStruct->Input, 2, doPush);
  emxInit_real_T(&pStruct->t_weight, 2, doPush);
  emxInit_real_T2(&pStruct->WeightMat, 3, doPush);
  emxInit_real32_T(&pStruct->spikes, 2, doPush);
  emxInit_real_T(&pStruct->EcellIDX, 2, doPush);
  emxInit_real_T(&pStruct->IcellIDX, 2, doPush);
}
...
void emxInit_boolean_T1(emxArray_boolean_T **pEmxArray, int32_T numDimensions,
  boolean_T doPush)
{
  emxArray_boolean_T *emxArray;
  int32_T i;
...
void emxInit_int32_T1(emxArray_int32_T **pEmxArray, int32_T numDimensions,
                      boolean_T doPush)
{
  emxArray_int32_T *emxArray;
  int32_T i;
...
void emxInit_real32_T1(emxArray_real32_T **pEmxArray, int32_T numDimensions,
  boolean_T doPush)
{
  emxArray_real32_T *emxArray;
  int32_T i;
...
void emxInit_real_T2(emxArray_real_T **pEmxArray, int32_T numDimensions,
                     boolean_T doPush)
{
  emxArray_real_T *emxArray;
  int32_T i;
...
/* End of code generation (CAdLIFfunction_STDP_emxutil.cu) */
