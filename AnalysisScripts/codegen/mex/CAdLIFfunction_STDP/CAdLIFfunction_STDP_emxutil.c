...
void emxFreeStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct)
{
  ...
  emxFree_real_T(sp, &pStruct->V);
  emxFree_real_T(sp, &pStruct->g_w);
  emxFree_real_T(sp, &pStruct->g_e);
  emxFree_real_T(sp, &pStruct->g_i);
  emxFree_real_T(sp, &pStruct->s);
  emxFree_real_T(sp, &pStruct->w);
  emxFree_real_T(sp, &pStruct->a_w);
  emxFree_real_T(sp, &pStruct->Input);
  emxFree_real_T(sp, &pStruct->t_weight);
  emxFree_real_T(sp, &pStruct->WeightMat);
  emxFree_real32_T(sp, &pStruct->spikes);
  emxFree_real_T(sp, &pStruct->EcellIDX);
  emxFree_real_T(sp, &pStruct->IcellIDX);
}
  ...
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_real_T(sp, &pStruct->g_w, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->g_e, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->g_i, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->s, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->w, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->a_w, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Input, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->t_weight, 2, srcLocation, doPush);
  emxInit_real_T2(sp, &pStruct->WeightMat, 3, srcLocation, doPush);
  emxInit_real32_T(sp, &pStruct->spikes, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->EcellIDX, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->IcellIDX, 2, srcLocation, doPush);
}
...
/* End of code generation (CAdLIFfunction_STDP_emxutil.c) */
