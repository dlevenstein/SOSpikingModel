...
static emlrtRTEInfo fi_emlrtRTEI = { 19,/* lineNo */
  5,                                   /* colNo */
  "error",                             /* fName */
...
{
  emlrtErrorWithMessageIdR2018a(sp, &fi_emlrtRTEI, "MATLAB:nologicalnan",
...
void error(const emlrtStack *sp)
{
  ...
  emlrtErrorWithMessageIdR2018a(sp, &fi_emlrtRTEI,
