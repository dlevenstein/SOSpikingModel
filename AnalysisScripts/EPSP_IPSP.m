...
figure
subplot(2,1,1)
plot(log10(W),VEmax(:,1),'.-','Color',[0.7 0.7 1],'linewidth',2,'markersize',25)
hold on
plot(log10(W),VEmax(:,2),'.-','Color',[0.3 0.3 1],'linewidth',2,'markersize',25)
hold on
plot(log10(W),VEmax(:,3),'.-','Color',[0 0 0.5],'linewidth',2,'markersize',25)
LogScale('x',10)
xlabel('Weight (nS)','fontsize',20);ylabel('Voltage mV','fontsize',20);title('EPSP','fontsize',20)
legend('G: 1','G: 3','G: 10','Location','northwest')
subplot(2,1,2)
plot(log10(W),VImin(:,1),'.-','Color',[1 0.7 0.7],'linewidth',2,'markersize',25)
hold on
plot(log10(W),VImin(:,2),'.-','Color',[1 0.3 0.3],'linewidth',2,'markersize',25)
hold on
plot(log10(W),VImin(:,3),'.-','Color',[0.5 0 0],'linewidth',2,'markersize',25)
