...
%
%--------------------------------------------------------------------------
function [SimValues] = FEULERAdLIFfunction(PopParams,TimeParams,varargin)
...
v(:,n+1) = v(:,n) + dt.*dV(v(:,n),g_e(:,n),g_i(:,n),a(:,n));
...
a_e(:,n+1) = a_e(:,n) + dt.*dA_e(a_e(:,n));

%--------------------------------------------------------------------------

b_e(:,n+1) = b_e(:,n) + dt.*dB_e(b_e(:,n));

%--------------------------------------------------------------------------

a_i(:,n+1) = a_i(:,n) + dt.*dA_i(a_i(:,n));

%--------------------------------------------------------------------------

b_i(:,n+1) = b_i(:,n) + dt.*dB_i(b_i(:,n));
